...
class phMagickTextObjectDefaults{
	...
	public static $useCaption = false;

    public static $gravity = false; //phMagickGravity::Center; //ignored in fromString()
    public $Text = '';
...
class phMagickTextObject {
    ...
    public function __construct(){
		...
		$this->useCaption = phMagickTextObjectDefaults::$useCaption;
    }
	...
	function defaultUseCaption($value){
		phMagickTextObjectDefaults::$useCaption = $value;
	}
	...
	function useCaption( $useCaption){
