{*<script type="text/javascript" src="_custom/js/media.js"></script>*}
{*<link rel="stylesheet" type="text/css" href="_custom/css/media.css" />*}

{*<script type="text/javascript" src="_custom/lib/uploadify/jquery.uploadify.min.js"></script>*}
{*<link rel="stylesheet" type="text/css" href="_custom/lib/uploadify/uploadify.css" />*}

<div class="row-fluid">

	<div class="page-header form-header">
		<h1><a href="_content.php">{$Grid.Title}</a></h1>
	</div>
		...
		<form class="form-horizontal"  enctype="multipart/form-data" method="POST" action="{$Grid.FormAction}">
			...
			<fieldset>
				...
				{foreach key=HiddenValueName item=HiddenValue from=$HiddenValues}
					...
					<input type="hidden" name="newhash" id="newhash" value="{php}echo uniqid(){/php}" />
				{/foreach}
				...
				{*<div class="control-group">*}
					{*<div class="controls">*}
						{*<a href="_content.php?hname=_mediaDetailEdit0_content_handler&fk0={$HiddenValues.pk0}" class="btn">UREDI SLIKE</a>*}
						{*<a href="_content.php?hname=_fileDetailEdit1n_content_handler&fk0={$HiddenValues.pk0}" class="btn">UREDI PRIPONKE</a>*}
					{*</div>*}
				{*</div>*}
			</fieldset>
