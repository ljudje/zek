...
if(! defined('MAGIC_PATH') )				define ('MAGIC_PATH', 'convert'); 						// path to imagemagick's convert
...
if(! defined('MAX_WIDTH') ) 			define ('MAX_WIDTH', 800);									// Maximum image width
if(! defined('MAX_HEIGHT') ) 			define ('MAX_HEIGHT', 800);								// Maximum image height
